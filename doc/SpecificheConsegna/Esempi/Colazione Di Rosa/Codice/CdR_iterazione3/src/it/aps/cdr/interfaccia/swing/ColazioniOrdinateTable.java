...
public class ColazioniOrdinateTable extends JTable {
	...
	public ColazioniOrdinateTable(JPanel panel,AbstractTableModel atm) {
        super(atm);
        this.owner = panel;
        this.etm = atm;
        this.setFont(FONT);
	...
	protected void buildGUI() {
		...
		this.defineColumnAlignment("modalita' di servizio",JLabel.LEFT);
	}
    ...
    public void setOrdine(Ordine o) {
    	((ColazioniOrdinateTableModel)this.etm).setOrdine(o);
