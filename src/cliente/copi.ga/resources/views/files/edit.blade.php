...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Modifica il tipo di file</div>
                  ...
                  @endif
                    <form method="post" action="{{ route('files.update', $file->id) }}">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="categoria_file" value={{ $file->categoria }} />
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="estensioni_file" value={{ $file->estensione }} />
                        </div>
