...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>COPI</b>GA</span>
    </a>
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{ asset('AdminLTE-2.4.5') }}/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="https://copi.ga">Copiga</a>.</strong> All rights
    reserved.
  </footer>
